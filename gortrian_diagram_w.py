...
def main():
    ...
    max_level = 10
    plt.title("W$^{2+}$ Gortrian Diagram")
    ...
    for ii in range(0,len(log_gf)):
        ...
        if (upper < max_level+1) and (lower < max_level+1):
            ...
            #    
            #    
    unique_csfs = ['5d$^4$ $^5$D','5d$^4$ $^3$P','5p$^3$ 6s $^5$F','5d$^4$ $^3$H']
    ...
    ax.arrow(1.5,0,0,dy*0.8,color='green',linewidth=1.5,head_width=0.05)
    ax.arrow(1.5,dy,0,-dy*0.8,color='green',linewidth=1.5,head_width=0.05)

    dy2 = energy_levels_cm_minus_one[2]
    ax.arrow(1.8,dy,0,(dy2-dy)*0.8,color='green',linewidth=1.5,head_width=0.05)
    ax.arrow(1.8,dy2,0,-(dy2-dy)*0.8,color='green',linewidth=1.5,head_width=0.05)

    plt.text(2.0,0.5*energy_levels_cm_minus_one[1],'$\lambda = 4.4 \mu$m')
    plt.text(2.0,0.5*energy_levels_cm_minus_one[2]+0.5*energy_levels_cm_minus_one[1],'$\lambda = 4.5 \mu$m')
